...
export const roleList = [
    {
        ...
        createTime: Date.now() - 3600000,
        description: '管理员',
        permission: ["/dashboard", "/nested", "/nested/menu1", "/nested/menu2", "/nested/menu1/menu1-1", "/nested/menu1/menu1-2", "/nested/menu1/menu1-1/menu1-1-1", "/nested/menu1/menu1-1/menu1-1-2", "/h5", "/drag", "/permission", "/permission/role", "/permission/user","/templateEditor", "https://github.com/PanJiaChen/vue-element-admin"]
    },
    {
        key: '2',
        role: 'editor',
